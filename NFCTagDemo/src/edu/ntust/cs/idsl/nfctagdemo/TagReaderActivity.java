...
public class TagReaderActivity extends NfcReaderActivity {

    private static final String TAG = TagReaderActivity.class.getName();
    ...
    public void readNdefMessage(Message message) {
        ...
        String type = getType(ndef.getType());
        int maxSize = ndef.getMaxSize();

        setResult(Activity.RESULT_OK,
                TagReaderFragment.getIntentForResult(type, maxSize, message));
        finish();
    }
